...
subprojects {
    ...
    cloudstream {
        setRepo(System.getenv("GITHUB_REPOSITORY") ?: "https://github.com/Makairamei/DRACIN")
        authors = listOf("Makairamei")
    }

    android {
        namespace = "com.klikfilm"
    ...
    dependencies {
        ...
        implementation("org.jsoup:jsoup:1.17.2") // Untuk parsing HTML
        ...
        implementation("org.jetbrains.kotlinx:kotlinx-coroutines-android:1.8.1") // Untuk coroutines di Android
        ...
        implementation("com.google.code.gson:gson:2.10.1") // Untuk serialisasi/deserialisasi JSON
        implementation("org.jetbrains.kotlinx:kotlinx-serialization-json:1.6.3") // Untuk serialisasi/deserialisasi JSON
        ...
        implementation("androidx.core:core-ktx:1.13.1") // Untuk Log dan utilitas Android
        implementation("org.jetbrains.kotlinx:kotlinx-coroutines-core:1.8.1") // Untuk coroutines
    }
}
